...
class FinanceVaConfigData:
    ...
    account_no: str
    account_name: str
    purpose: Optional[List[str]] = field(default_factory=list)
    fee: int
    partner_id: str
    client_id: str
    client_secret: str
...
class FinanceVaConfigSchema(Schema):
    ...
    purpose = ma_fields.List(ma_fields.String(), required=True)
...
class FinanceVaConfig(BaseModel):
    ...
    search = ["prefix", "name", "account_no", "account_name"]
    ...
    foreign_key = {
        "bank": {
            ...
            "foreign": "_id",
            "sort": None,
            "fields": "_id, code, name, short_name",
        ...
        "vendor": {
            ...
            "sort": None,
            "fields": "_id, code, name, short_name",
            "model": lambda: __import__("models.finance_va_vendor").finance_va_vendor.FinanceVaVendor(),
        },
        "coa": {
            "local": "coa_id",
            "foreign": "_id",
            "sort": None,
            "fields": "_id, code, name, type, group",
            "model": lambda: __import__("models.account_account").account_account.AccountAccount(),
        },
        "holding": {
            "local": "holding_id",
            "foreign": "_id",
            "sort": None,
            "fields": "_id, code, name, dislay_name",
