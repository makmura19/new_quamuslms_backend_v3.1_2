...
class MainService(BaseService):
    ...
    @staticmethod
    def validate_upload_images(value, _extra, secret, user, old_data=None):
        from utils.dict_util import DictUtil
    ...
    def upload_images(
        ...
        if validated_data.get("file1"):
            ...
            bar_img_url = FileStorageUtil.upload_aws(
                validated_data.get("file1"), "subject_level_bar_img"
            )
            if not bar_img_url:
        ...
        if validated_data.get("file2"):
            ...
            thumbnail_img_url = FileStorageUtil.upload_aws(
                validated_data.get("file2"), "subject_level_thumbnail_img"
            )
